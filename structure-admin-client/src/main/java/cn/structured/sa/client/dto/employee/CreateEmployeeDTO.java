...
public class CreateEmployeeDTO {
    ...
    @NotBlank
    @ApiModelProperty(value = "部门id", example = "[1645717015337684992,1645717015337684992]", required = true)
    private String dept;
    ...
    @ApiModelProperty(value = "用户ID", example = "1645717015337684992", notes = "绑定用户ID，邀请用户")
    private Long userId;
}
